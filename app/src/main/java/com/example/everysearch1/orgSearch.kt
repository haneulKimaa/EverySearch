...
class orgSearch : AppCompatActivity() {
    companion object{
        val context: Any=orgSearch.context
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val searchIntent = Intent(this, searchResult_org()::class.java)
        ...
        teamSpinner.onItemSelectedListener = object : AdapterView.OnItemSelectedListener,
            ...
            override fun onItemSelected(
                ...
                var keyword2=teamAdapter.getItem(position).toString()
                searchIntent.putExtra(keyword, keyword2)
            }
